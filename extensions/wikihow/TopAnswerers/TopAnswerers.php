...
$wgAutoloadClasses['TAUpdateStatsJob'] 						= dirname(__FILE__) . '/jobs/TAUpdateStatsJob.php';
$wgAutoloadClasses['TAInsertArticleQuestionJob'] 	= dirname(__FILE__) . '/jobs/TAInsertArticleQuestionJob.php';

$wgJobClasses['TAUpdateStatsJob'] 					= 'TAUpdateStatsJob';
...
$wgHooks['UpdateAnswererStats'][] 	= ['TopAnswerers::onUpdateAnswererStats'];
