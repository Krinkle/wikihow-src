<div class='section kb-submit-section' id='knowledgebox-submit' style='display: none;'>
	...
	<div class='kb-submit-form-container'>
		<form id='kb-submit-form' action='#'>
			...
			>
				<span class='kb-fancy-input-placeholder' id='kb-placeholder'><?=wfMsg('kb-tell-us-expanded')?></span>
			</div>
			<div class='kb-content-box'>
				...
				<div class='kb-tips-box'>
					...
					<div class='kb-tips-header'>
						<strong><?=wfMsg('kb-tips-header')?></strong>
					</div>
					<div class='kb-tips-details'>
						<?=wfMsg('kb-tips-details')?><br />
						<strong><?=wfMsg('kb-dont-say')?></strong>: <em><?=wfMsg('kb-dont-say-example')?></em></br>
						<strong><?=wfMsg('kb-do-say')?></strong>: <em><?=wfMsg('kb-do-say-example')?></em></br>
					</div>
				</div>
				<div class='kb-form-bottom'>
					<div class='kb-form-bottom-left'>
						<input placeholder='<?=wfMsg('kb-email-prompt')?>' class='kb-input' id='kb-email'>
						<input placeholder='<?=wfMsg('kb-name-prompt')?>' class='kb-input' id='kb-name'>
					</div>
					<div class='kb-form-bottom-right'>
						<a href="#" class='button primary op-action' id='kb-add' role='button' tabindex='0'><?=wfMsg('submit')?></a>
