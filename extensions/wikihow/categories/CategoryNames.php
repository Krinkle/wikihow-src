...
elseif($wgLanguageCode == 'ja') {
	$wgCategoryNames = array(
			CAT_ARTS      => "アート・エンターテイメント",
			CAT_CARS      => "車・乗り物",
			CAT_COMPUTERS     => "パソコン・エレクトロニクス",
			CAT_EDUCATION     => "教育関連・コミュニケーション",
			CAT_FAMILY      => "家族生活",
			CAT_FINANCE     => "ビジネス・ファイナンス",
			CAT_FOOD      => "食物・イベント",
			CAT_HEALTH      => "健康",
			CAT_HOBBIES     => "趣味・クラフト",
			CAT_HOLIDAYS    => "ホリデー・伝統",
			CAT_HOME      => "インテリア・ガーデニング",
			CAT_PERSONAL    => "パーソナルケア・スタイル",
			CAT_PETS      => "ペット・動物",
			CAT_PHILOSOPHY    => "哲学・宗教",
			CAT_RELATIONSHIPS   => "対人関係",
