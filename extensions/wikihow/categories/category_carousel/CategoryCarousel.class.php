...
class CategoryCarousel {
	...
	public function getCarouselHtml() {
		...
		return $m->render('category_carousel', $this->getFormattedData('', $this->getLimit()));
	}
	...
	protected function getLimit() {
		if ($this->isLeafNode || $this->isArticleView) {
			$limit = 30;
	...
	public function getMoreArticles($sortKey, $limit, $isFeatured) {
		$data = $this->getFormattedData($sortKey, $limit, $isFeatured);
	...
	protected function getFormattedData($sortKey, $limit, $includeFeatured = true) {
		$data = $this->catData->getAllData($sortKey, $limit, $includeFeatured);
